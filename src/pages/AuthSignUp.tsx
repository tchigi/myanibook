...
const AuthSignUp = () => {
    ...
    const signUpOnClickHandler = (e: any) => {
        ...
        axios
            ...
            .catch((e) => {
                setIsLoading(false)
                setError(e.message === 'Network Error' ? 'Sorry! Registration server is temporarily unavailable.' : e.message)
            })
    }
    ...
    return (
        <AuthStyled>
            <AuthInfoContainerStyled>
                {isLoading ? <Loading /> : ''}
                <AuthTitleStyled>Start Using MyAniBook</AuthTitleStyled>
                <AuthSubTitleStyled>Join MyAniBook to catalog your anime, compare with your friends, create your own profile, and plenty more. It's Free.</AuthSubTitleStyled>
                <AuthFormWrapperStyled>
                    <AuthFormStyled action="">
                        ...
                        <AuthFormButtonStyled onClick={signUpOnClickHandler}>
                            <AuthFormItemLabelStyled>Sign Up</AuthFormItemLabelStyled>
                        </AuthFormButtonStyled>
                    </AuthFormStyled>
                </AuthFormWrapperStyled>
                <AuthSubTitleStyled>
                    Already have an account?
                    <AuthFormSignupButtonStyled onClick={onClickLogInHandler}>
                        <AuthFormSignupButtonLabelStyled>Log In</AuthFormSignupButtonLabelStyled>
